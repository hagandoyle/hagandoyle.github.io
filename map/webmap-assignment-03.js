...
let BellTower = L.icon({
  ...
  iconAnchor: [30.414468, -91.178897], // point of the icon which will correspond to marker's location
  popupAnchor: [30.414471, -91.178664] // point from which the popup should open relative to the iconAnchor
})
